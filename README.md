# 基于 Verilog 的 32 位五级流水线 MIPS 处理器架构实现

> *作为独立的硬件微架构展示项目（脱胎于电子科技大学《计算机组成与系统结构 II》核心实验），本项目使用 Verilog HDL 从零构建了支持 12 条 MIPS 指令的单周期与 5 级流水线 CPU，并深入实现了针对数据冒险与控制冒险的底层应对机制。*
## 项目简介
